...
from schedulr.modules.user.user_database import FakeUserDatabase, RealUserDatabase, User, UserNotFound
...
class TestUserDatabase:
    ...
    def test_that_registered_users_can_be_fetched(self) -> None:
        user_database = self.dependency_injection.get(RealUserDatabase, FakeUserDatabase)
