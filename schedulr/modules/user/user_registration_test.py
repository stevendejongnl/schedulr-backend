...
from schedulr.modules.user.user_registration import RealUserRegistration, FakeUserRegistration, UserRegistered, \
    UserNotRegistered
...
class TestUserRegistration:
    def setup_method(self) -> None:
        ...
        self.user_database = self.dependency_injection.get(RealUserDatabase, FakeUserDatabase)
        self.user_registration = self.dependency_injection.get(RealUserRegistration, FakeUserRegistration, database=self.user_database)
    ...
    def test_that_you_can_not_register_with_an_already_registered_email(self) -> None:
        ...
        second_user_registered = self.user_registration.register(second_user_email, second_user_password)
